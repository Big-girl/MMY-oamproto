...
var file_oam_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x32, 0xf2, 0x0c, 0x0a, 0x09, 0x4f, 0x41, 0x4d, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x3a, 0x01, 0x2a, 0x42, 0x09, 0x5a, 0x07, 0x2e, 0x3b, 0x70, 0x72, 0x6f,
...
var file_oam_proto_goTypes = []interface{}{
	...
	(*GetCliLogFlagsReply)(nil),           // 15: GetCliLogFlagsReply
	(*GetCliUpFlagsReply)(nil),            // 16: GetCliUpFlagsReply
	(*AcceptClientListReply)(nil),         // 17: AcceptClientListReply
	(*ListClientReply)(nil),               // 18: ListClientReply
	(*OAMClient)(nil),                     // 19: OAMClient
	(*UpdateClientReply)(nil),             // 20: UpdateClientReply
	(*ListPolicyReply)(nil),               // 21: ListPolicyReply
	(*OperateReply)(nil),                  // 22: OperateReply
	(*GetPolicyReply)(nil),                // 23: GetPolicyReply
	(*AcceptTenantListReply)(nil),         // 24: AcceptTenantListReply
	(*GetServerIpReply)(nil),              // 25: GetServerIpReply
	(*PlatReply)(nil),                     // 26: PlatReply
	(*ActivePlatInfoReply)(nil),           // 27: ActivePlatInfoReply
}
var file_oam_proto_depIdxs = []int32{
	...
	0,  // 20: OAMServer.Ping:output_type -> Pong
	15, // 21: OAMServer.GetCliLogFlags:output_type -> GetCliLogFlagsReply
	16, // 22: OAMServer.GetCliUpFlags:output_type -> GetCliUpFlagsReply
	17, // 23: OAMServer.AcceptClientList:output_type -> AcceptClientListReply
	18, // 24: OAMServer.ListClient:output_type -> ListClientReply
	19, // 25: OAMServer.GetClient:output_type -> OAMClient
	20, // 26: OAMServer.BatchUpdateClientFlags:output_type -> UpdateClientReply
	21, // 27: OAMServer.ReleasePolicy:output_type -> ListPolicyReply
	22, // 28: OAMServer.AddPolicy:output_type -> OperateReply
	22, // 29: OAMServer.PutPolicy:output_type -> OperateReply
	22, // 30: OAMServer.DelPolicy:output_type -> OperateReply
	21, // 31: OAMServer.ListPolicy:output_type -> ListPolicyReply
	23, // 32: OAMServer.GetPolicy:output_type -> GetPolicyReply
	9,  // 33: OAMServer.ListModelVersion:output_type -> ModelVersion
	24, // 34: OAMServer.AcceptTenantList:output_type -> AcceptTenantListReply
	25, // 35: OAMServer.GetServerIp:output_type -> GetServerIpReply
	26, // 36: OAMServer.AddPlatAccount:output_type -> PlatReply
	26, // 37: OAMServer.AddPlatLicense:output_type -> PlatReply
	26, // 38: OAMServer.SendActiveCode:output_type -> PlatReply
	27, // 39: OAMServer.ActivePlatInfo:output_type -> ActivePlatInfoReply
